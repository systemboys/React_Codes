...
- [Formatação de Dados da API em um Array no Formato Específico (JSON)](#formata%C3%A7%C3%A3o-de-dados-da-api-em-um-array-no-formato-espec%C3%ADfico "Formatação de Dados da API em um Array no Formato Específico (JSON)")
